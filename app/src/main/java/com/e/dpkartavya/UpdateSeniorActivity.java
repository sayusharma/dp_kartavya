...
import com.e.dpkartavya.Common.CurrentUpdate;
...
public class UpdateSeniorActivity extends AppCompatActivity implements SeniorAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText = findViewById(R.id.searchByNameUpdateEditText);
        mobEditText = findViewById(R.id.searchByMobUpdateEditText);
    ...
    public void onClickBackUpdateSenior(View view){
        Intent intent = new Intent(UpdateSeniorActivity.this,DashActivity.class);
        startActivity(intent);
    }
    @Override
    public void onClick(int position) {
        Intent intent = new Intent(UpdateSeniorActivity.this,EditSeniorActivity.class);
        CurrentUpdate.currentUpdate = cuurentArrayList.get(position);
        startActivity(intent);
    }
