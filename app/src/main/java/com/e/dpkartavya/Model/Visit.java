...
public class Visit {
    private String name,mob,addr,photo,police_officer,date,time;
    public Visit(){}
    ...
    public Visit(String name, String mob, String addr, String photo, String police_officer, String date, String time) {
        this.name = name;
        this.mob = mob;
        this.addr = addr;
        this.photo = photo;
